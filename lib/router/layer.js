...
function Layer(path, options, fn) {
  ...
  this.path = undefined;
  this.regexp = getPathRegexp(path, this.keys = [], opts);
...
/**
 * Compile `path` to a regexp.
 *
 * Uses path-to-regexp@8 for supported patterns and falls back
 * to the legacy compiler to preserve Express 4 route semantics.
 *
...
function getPathRegexp(path, keys, options) {
...
/**
 * Legacy path-to-regexp@0.1.7 compiler.
 *
 * @param {String|RegExp|Array} path
 * @param {Array} keys
 * @param {Object} options
